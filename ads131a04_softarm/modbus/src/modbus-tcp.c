...
/*********************************************************************
 * @fn		_modbus_tcp_build_request_basis
 *
 * @brief	Builds a TCP request header
 *
 * @param	ctx, function, addr, nb, req
 *
 * @return	int
 *
 * @author	liuch
...
/*********************************************************************
 * @fn		_modbus_tcp_build_response_basis
 *
 * @brief	Builds a TCP response header 
 *
 * @param	sft, rsp
 *
 * @return	int
...
/*********************************************************************
 * @fn		_modbus_tcp_pi_connect
 *
 * @brief	Establishes a modbus TCP PI connection with a Modbus server.
 *
 * @param	ctx
 *
 * @return	int
...
/*********************************************************************
 * @fn		modbus_tcp_accept
 *
 * @brief	On success, the function return a non-negative integer that is a descriptor
