...
/*=================================================================
  ...
  11/01/2018       laurence    modify UPDATE_MSD_TIMEOUT annotation.
...
typedef enum 
{
    ...
    MCM_VOICE_CALL_STATE_SETUP              = 0x0007, /**< MT Call is in Setup state in 3GPP. */
...
typedef enum 
{
  ...
  E_QL_MCM_VOICE_ECALL_EVENT_MSDUPDATE_PSAP_REQURE_UPDATE_MSD   = 1, /**<  Indicate to update MSD in 5 seconds. */
  E_QL_MCM_VOICE_ECALL_EVENT_MSDUPDATE_IVS_UPDATE_MSD_TIMEOUT   = 2  /**<  Indicate timeout of updating MSD and module starts to transfer the old MSD. */
